...
/**
 * help_for_all - Displays all possible LSH builtin commands.
 */
void help_for_all(void)
{
...
/**
 * help_for_alias - Displays information on the LSH builtin command 'alias'.
 */
void help_for_alias(void)
{
...
/**
 * help_for_cd - Displays information on the LSH builtin command 'cd'.
 */
void help_for_cd(void)
{
...
/**
 * help_for_exit - Displays information on the LSH builtin command 'exit'.
 */
void help_for_exit(void)
{
...
/**
 * help_for_help - Displays information on the LSH builtin command 'help'.
 */
void help_for_help(void)
{
